...
// CODE HERE
// let numDivide = numbers.forEach((elem) => console.log(elem/2))
...
// CODE HERE
let newNumArr = numbers.map((elem) => elem/2)
...
//let iCity = cities.filter((city) => city.endsWith("i"))
// console.log(iCity)
...
// CODE HERE
const meat = foods.filter((elem) => elem.tags.includes('meat')).reduce((total, price) => total + price.price, 0)
console.log(meat)
